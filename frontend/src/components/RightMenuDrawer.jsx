    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between bg-white/[0.01]">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.08] text-zinc-400 hover:text-white transition-all"
            title="Fechar menu"
          >
            <X className="w-5 h-5" />
          </button>
            ...
            if (item.enabled) {
              return (
                <button
                  ...
                  className={`w-full text-left p-3.5 rounded-2xl flex items-center justify-between transition-all duration-200 group ${
                    isActive
        ...
        <div className="p-4 border-t border-white/5 bg-black/30 space-y-3">
          <button
            ...
            className="w-full py-3 px-4 rounded-xl border border-red-500/20 bg-red-500/10 hover:bg-red-500/20 text-red-400 hover:text-red-300 text-xs font-bold flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
          >
          ...
          <div className="text-center">
            <span className="text-[10px] text-zinc-600 font-medium tracking-wide">
              DeclarAtivo v2.0 · Frontend Renovado
            </span>
          </div>
        </div>
      </aside>
